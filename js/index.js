// Сортировка в таблицах от большего к меньшему
...
// Проверяем локалсторедж, хотим получить элемент с ключем goods 
// и если его нет, то добавим. С помощью JSON.stringify конвертируем массив в строку
if(!localStorage.getItem('goods')) {
    localStorage.setItem('goods', JSON.stringify([]))
}

let myModal = new bootstrap.Modal(document.getElementById('examplModal'), {
    keyboard: false
})
...
if(goods.length) {
 ...
 // Вывести цену в итог
document.querySelector('.price_result').innerHTML = result_price + " &#8372"
}
...
// Удаление товара из корзины и возврат в магазин 
